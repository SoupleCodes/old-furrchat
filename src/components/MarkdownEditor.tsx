...
return (
    <div>
      <div className="markdown-container">
        ...
        <Dropdown options={headingOptions} onSelect={(option: any) => handleMarkdownClick(option.value + ' ', false)} />
    ...
    <form onSubmit={sendPost} style={{ display: 'flex' }}>
      ...
      style={{ 
        ...
        paddingBottom: '35px',
        height: '50px',
        background: 'linear-gradient(to bottom, rgba(255, 255, 255, 0.8) 0%, rgba(72, 173, 148, 0.3) 100%)',
        borderColor: '4px solid rgba(0, 0, 0, 0.2)',
        borderRadius: '10px',
        boxShadow: 'inset 3px 3px 5px rgba(0, 0, 0, 0.1), 5px 5px 10px rgba(0, 0, 0, 0.2)',
        padding: '10px'
      }}
